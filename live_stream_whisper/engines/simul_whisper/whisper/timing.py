...
def median_filter(x: torch.Tensor, filter_width: int):
    ...
    if x.is_cuda:
        ...
        except (RuntimeError, subprocess.CalledProcessError, ValueError, TypeError, AttributeError) as e:
            error_traceback = traceback.format_exc()
            strError = f"Failed to launch Triton median kernel; xx falling back to a slower implementation...\n{error_traceback}"
